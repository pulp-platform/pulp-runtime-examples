...
static int cluster_entry()
{
  ...
  uint32_t * im2col_2               = &buffer_im2col[0 + IFM_CH_NN * DIM_KER_NN * DIM_KER_NN>>2];
  int32_t * filter_1               = &filters_3d[0];
  int32_t * filter_2               = &filters_3d[0 + IFM_CH_NN * DIM_KER_NN * DIM_KER_NN>>2];
  int32_t * filter_3               = &filters_3d[0 + 2 *IFM_CH_NN * DIM_KER_NN * DIM_KER_NN>>2];
  int32_t * filter_4               = &filters_3d[0 + 3 *IFM_CH_NN * DIM_KER_NN * DIM_KER_NN>>2];
  ...
  synch_barrier();
   for(int i=0 ; i < ((IFM_CH_NN * DIM_KER * DIM_KER) >> 4); i++) {
      ...
      temp0 = __builtin_pulp_mlsdotsup16_v3(0,0, 0, 0, filter_1, temp0);
      temp1 = __builtin_pulp_mlsdotsup16_v3(0,0, 1, 0, filter_2, temp1);
      temp2 = __builtin_pulp_mlsdotsup16_v3(0,0, 2, 0, filter_3, temp2);
      temp3 = __builtin_pulp_mlsdotsup16_v3(0,1, 3, 0, im2col_1, temp3); // update SPRA[0] with new im2col_1 element
      im2col_1 = __builtin_pulp_mlupdatespr_v3(im2col_1);
      temp4 = __builtin_pulp_mlsdotsup16_v3(1,0, 0, 1, filter_1, temp4); // update SPRW[0] with new filter_1 element
      filter_1 = __builtin_pulp_mlupdatespr_v3(filter_1);
      temp5 = __builtin_pulp_mlsdotsup16_v3(1,0, 1, 1, filter_2, temp5); // update SPRW[1] with new filter_2 element
      filter_2 = __builtin_pulp_mlupdatespr_v3(filter_2);
      temp6 = __builtin_pulp_mlsdotsup16_v3(1,0, 2, 1, filter_3, temp6); // update SPRW[2] with new filter_3 element
      filter_3 = __builtin_pulp_mlupdatespr_v3(filter_3);
      temp7 = __builtin_pulp_mlsdotsup16_v3(1,0, 3, 1, filter_4, temp7); // update SPRW[3] with new filter_4 element
