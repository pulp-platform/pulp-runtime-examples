...
#define OUT_PIX_NN	2
	...
	L1_DATA uint8_t W2_su[(IFM_CH * DIM_KER_SUBBYTE * DIM_KER_SUBBYTE * OFM_CH) >> 2]=WEIGHTS_2_SU;
	L1_DATA int8_t  X2_su[(OUT_PIX * IFM_CH * DIM_KER_SUBBYTE  * DIM_KER_SUBBYTE) >> 2]= IFM_2_SU;
